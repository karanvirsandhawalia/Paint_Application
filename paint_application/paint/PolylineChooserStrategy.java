 ...
 * the drawing mode to polyline
 *
 * This class implements the ChooserStrategy for polyline.
 ...
 *
 */
public class PolylineChooserStrategy implements ChooserStrategy{

    /**
     * Sets the drawing mode to polyline. Displaying on the Paint application that
     * the current drawing mode is polyline.
     *
    ...
    public void setMode(ShapeChooserPanel chooserPanel) {
        chooserPanel.viewSetMode("Polyline");
        chooserPanel.resetButtons();
        chooserPanel.getLisButtons().get(chooserPanel.getButtonLabels().indexOf("Polyline")).setStyle(
