 ...
 * the drawing mode to eraser.
 *
 * This class implements the ChooserStrategy for eraser.
 ...
 *
 */
public class EraserChooserStrategy implements ChooserStrategy{

    /**
     * Sets the drawing mode to eraser. Displaying on the Paint application that
     * the current drawing mode is eraser.
     *
    ...
    public void setMode(ShapeChooserPanel chooserPanel) {
        chooserPanel.viewSetMode("Eraser");
        chooserPanel.resetButtons();
        chooserPanel.getLisButtons().get(chooserPanel.getButtonLabels().indexOf("Eraser")).setStyle(
