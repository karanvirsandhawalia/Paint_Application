 ...
 * the drawing mode to Oval
 *
 * This class implements the ChooserStrategy for Oval.
 ...
 *
 */
public class OvalChooserStrategy implements ChooserStrategy{

    /**
     * Sets the drawing mode to Oval. Displaying on the Paint application that
     * the current drawing mode is Oval.
     *
    ...
    public void setMode(ShapeChooserPanel chooserPanel) {
        chooserPanel.viewSetMode("Oval");
        chooserPanel.resetButtons();
        chooserPanel.getLisButtons().get(chooserPanel.getButtonLabels().indexOf("Oval")).setStyle(
