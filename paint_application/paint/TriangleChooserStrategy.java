 ...
 * the drawing mode to triangle.
 *
 * This class implements the ChooserStrategy for triangle.
 ...
 *
 */
public class TriangleChooserStrategy implements ChooserStrategy{

    /**
     * Sets the drawing mode to triangle. Displaying on the Paint application that
     * the current drawing mode is triangle.
     *
    ...
    public void setMode(ShapeChooserPanel chooserPanel) {
        chooserPanel.viewSetMode("Triangle");
        chooserPanel.resetButtons();
        chooserPanel.getLisButtons().get(chooserPanel.getButtonLabels().indexOf("Triangle")).setStyle(
